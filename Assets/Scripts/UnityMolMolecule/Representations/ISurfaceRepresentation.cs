...
namespace UMol
{
    public abstract class ISurfaceRepresentation : AtomRepresentation
    {
        ...
        public virtual int[] computeNearestVertexPerAtom(GameObject gomesh, UnityMolSelection sele,
        ...
        public virtual Dictionary<UnityMolAtom, List<int>> computeNearestVertexPerAtomCustom(GameObject gomesh,
