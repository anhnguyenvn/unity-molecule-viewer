    ...
    public class AtomRepresentationSphere : AtomRepresentation
    {
        ...
        private void DisplaySphere(Transform repParent)
        {
            ...
            for (int i = 0; i < selection.Count; i++)
            {
                ...
                t.name = selection.atoms[i].residue.chain.name + "_" + selection.atoms[i].residue.name +
                         selection.atoms[i].residue.id + "_" + selection.atoms[i].name + "_" +
                         selection.atoms[i].number;
