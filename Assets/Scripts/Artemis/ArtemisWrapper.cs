...
namespace UMol
{
    public class ArtemisWrapper
    {
        ...
        [DllImport("artemis")]
        public static extern int artemis_client_connect(ArtemisClientPointer client, [In] string hostname,
            [In] int port);
        ...
        [DllImport("artemis")]
        public static extern int artemis_client_read_energies(ArtemisClientPointer client,
            ref ArtemisImdEnergies energies);

        [DllImport("artemis")]
        public static extern int artemis_client_read_coords(ArtemisClientPointer client, [In, Out] float[] coords,
            int nb_atoms);
        ...
        [DllImport("artemis")]
        public static extern int artemis_client_send_forces(ArtemisClientPointer client, int nb_forces,
            [In] int[] indexes, [In] float[] forces);
        ...
        [DllImport("artemis")]
        public static extern int artemis_client_send_restraint(ArtemisClientPointer client,
            ArtemisEimdRestraint restraint);

        [DllImport("artemis")]
        public static extern int artemis_client_send_position_restraint(ArtemisClientPointer client,
        ...
        [DllImport("artemis")]
        public static extern int artemis_client_send_position_restraint_delete(ArtemisClientPointer client,
            int restraint_id);
    }
}